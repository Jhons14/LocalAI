...
export const PROVIDER_ICONS: Record<Provider, JSX.Element> = {
  ollama: <Ollama className='w-8 h-8  fill-white' />,
  openai: <OpenAI className='w-8 h-8  fill-white' />,
  anthropic: <Anthropic className='w-8 h-8  fill-white' />, // Temporary, can be replaced with Anthropic icon
  google: <Gemini className='w-8 h-8  fill-white' />, // Temporary, can be replaced with Google icon
};
