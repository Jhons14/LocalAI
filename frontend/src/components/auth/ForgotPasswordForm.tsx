...
export function ForgotPasswordForm({ onSuccess, onClose, onCloseAll, initialEmail = '' }: ForgotPasswordFormProps) {
  ...
  return (
    <div className="w-full">
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="forgot-email" className="block mb-2 font-medium text-black">
            Email
          </label>
          <input
            type="email"
