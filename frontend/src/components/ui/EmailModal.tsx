...
export const EmailModal = memo(function EmailModal({
  ...
  return (
    <div className='fixed inset-0 bg-black text-[#555555] bg-opacity-50 flex items-center justify-center z-50'>
      <div
      ...
      >
        ...
        <div className='flex justify-end gap-3 p-6 border-t'>
          <button
            ...
            className='px-4 py-2 cursor-pointer text-[#555555] border border-[#999999] rounded hover:bg-gray-50 transition-colors keyboard-navigation'
          >
            Cancel
          </button>
          <button
            ...
            className='px-4 py-2 bg-[#555555] cursor-pointer text-white rounded hover:bg-[#777777] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors keyboard-navigation'
          >
            Save
          </button>
        </div>
