...
export const ApiKeyModal = memo(function ApiKeyModal({
  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 '>
      <div
        className={`bg-white rounded-lg shadow-xl text-[#555555] ${
      ...
      >
        ...
        <div className='flex justify-end gap-3 p-6 border-t'>
          <button
            onClick={onClose}
            className='px-4 cursor-pointer py-2 text-[#555555] border border-[#999999] rounded hover:bg-gray-50 transition-colors keyboard-navigation'
          >
            Cancel
          </button>
          <button
            ...
            className='px-4 cursor-pointer py-2 bg-[#555555] text-white rounded hover:bg-[#777777] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors keyboard-navigation'
          >
            {loading ? 'Saving...' : 'Save'}
          </button>
        </div>
