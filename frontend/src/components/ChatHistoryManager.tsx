    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <div className="flex justify-between items-center p-6 border-b">
          ...
          <button
            onClick={onClose}
            className="text-gray-500 hover:text-gray-700 keyboard-navigation p-2"
        ...
        <div className="flex gap-2 p-6 border-b">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded hover:bg-gray-50 keyboard-navigation"
          >
            Refresh
          </button>
        </div>
